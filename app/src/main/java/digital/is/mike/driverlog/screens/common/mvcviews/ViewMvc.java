package digital.is.mike.driverlog.screens.common.mvcviews;
 ...
 * more Android View's while adding logic for communication with the MVC Controller.
 */
public interface ViewMvc {
     ...
     * object. The keys in the returned Buncle must be provided as public constants inside the
     ...
     * @return Bundle containing the stae of this MVC View, or null if the view has no state.
     */
